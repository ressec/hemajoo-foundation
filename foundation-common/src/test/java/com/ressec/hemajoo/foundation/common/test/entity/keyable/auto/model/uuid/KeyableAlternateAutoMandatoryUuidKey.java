 ...
 */
@Internal
public class KeyableAlternateAutoMandatoryUuidKey extends Keyable
{
    /**
     ...
     */
    @AlternateKey(name = "alternateAutoMandatoryUuid", auto = true, mandatory = true, unique = false)
    @Getter
    private UUID alternateAutoMandatoryUuid;

    /**
     * Avoid direct instantiation of entity.
     */
    private KeyableAlternateAutoMandatoryUuidKey()
    {
        // Empty.
    }
     ...
     * @param alternateAutoMandatoryUuid UUID value.
     */
    @Builder
    public KeyableAlternateAutoMandatoryUuidKey(final UUID primaryUuid, final UUID alternateAutoMandatoryUuid)
    {
        this.primaryUuid = primaryUuid;
        this.alternateAutoMandatoryUuid = alternateAutoMandatoryUuid;
