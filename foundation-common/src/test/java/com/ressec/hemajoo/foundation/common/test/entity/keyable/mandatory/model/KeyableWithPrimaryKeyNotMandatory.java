 ...
 * ---------------------------------------------------------------------------
 */
package com.ressec.hemajoo.foundation.common.test.entity.keyable.mandatory.model;
 ...
 */
@Internal
public class KeyableWithPrimaryKeyNotMandatory extends Keyable
{
    /**
     ...
     */
    private KeyableWithPrimaryKeyNotMandatory()
    {
        // Empty.
    }
     ...
     */
    @Builder
    public KeyableWithPrimaryKeyNotMandatory(final int numeric)
    {
