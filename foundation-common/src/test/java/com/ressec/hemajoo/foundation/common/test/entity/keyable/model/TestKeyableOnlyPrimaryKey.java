 ...
 */
@Internal
public class TestKeyableOnlyPrimaryKey extends AbstractKeyable
{
    /**
     * Name.
     */
     ...
     */
    private TestKeyableOnlyPrimaryKey()
    {
        // Empty.
    }

    @Builder
    public TestKeyableOnlyPrimaryKey(final String name)
    {
        this.name = name;
     ...
     */
    public static TestKeyableOnlyPrimaryKey empty()
    {
        return new TestKeyableOnlyPrimaryKey();
    }
     ...
     * @return {@link TestKeyableOnlyPrimaryKey} if found, null otherwise.
     */
    public static TestKeyableOnlyPrimaryKey get(final @NonNull String keyName, final @NonNull Object keyValue)
    {
        return (TestKeyableOnlyPrimaryKey) TestKeyableOnlyPrimaryKey.empty().firstFrom(keyName, keyValue);
    }
     ...
     * @return {@link TestKeyableOnlyPrimaryKey} if found, null otherwise.
     */
    public static TestKeyableOnlyPrimaryKey get(final @NonNull IKey key)
    {
        return (TestKeyableOnlyPrimaryKey) TestKeyableOnlyPrimaryKey.empty().firstFrom(key);
    }
}
